...
@with_backoff
def query_topic_institution(start_date_str, end_date_str, entity, query, chunks_per_day=day_chunk, rerank_chunk_return=rerank_chunk_return):
    """
...
def lambda_handler(event, context):
    ...
    payload = query_topic_institution(start_date_str,
                                       end_date_str,
                                       entity,
                                       query)
