...
#query = 'News related to national output, national income, Gross Domestic Product'
...
@with_backoff
def query_topic_elt(start_date_str, end_date_str, query, chunks_per_day=day_chunk, rerank_chunk_return=rerank_chunk_return):
    """
...
#    print(response)
    payload = {'topic':"economy_long_term",
...
def lambda_handler(event, context):
    ...
    payload = query_topic_elt(start_date_str,
                                       end_date_str,
                                       query)
    print(payload)
    agent = event['agent']
