...
#query = 'News related to consumers including retail, sales, spending and their effects on the economy'
...
@with_backoff
def query_topic_cb(start_date_str, end_date_str, query, chunks_per_day=day_chunk, rerank_chunk_return=rerank_chunk_return):
    """
...
#    print(response)
    payload = {'topic':"consumer_behavior",
...
def lambda_handler(event, context):
    ...
    payload = query_topic_cb(start_date_str,
                            end_date_str,
                            query)
    agent = event['agent']
