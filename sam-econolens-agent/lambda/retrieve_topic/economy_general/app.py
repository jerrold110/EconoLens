...
#query = 'General economic reports and happenings such as growth, slowdown, recession, or a downturn'
...
@with_backoff
def query_topic_eg(start_date_str, end_date_str, query, chunks_per_day=day_chunk, rerank_chunk_return=rerank_chunk_return):
    """
...
def lambda_handler(event, context):
    ...
    payload = query_topic_eg(start_date_str,
                                       end_date_str,
                                       query)
